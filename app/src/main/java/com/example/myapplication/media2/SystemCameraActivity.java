package com.example.myapplication.media2;
...
public class SystemCameraActivity extends AppCompatActivity {
    ...
    public static void startUI(Context context) {
        Intent intent = new Intent(context, com.example.myapplication.media2.SystemCameraActivity.class);
    ...
    private void takePhotoUsePathHasPermission() {
        ...
        intent.putExtra(MediaStore.EXTRA_OUTPUT, com.example.myapplication.media2.PathUtils.getUriForFile(this,takeImagePath));
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == REQUEST_CODE_TAKE_PHOTO && resultCode == RESULT_OK) {
            ...
            Bitmap rotateBitmap = com.example.myapplication.media2.PathUtils.rotateImage(bitmap,takeImagePath);

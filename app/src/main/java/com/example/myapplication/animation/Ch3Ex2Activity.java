...
public class Ch3Ex2Activity extends AppCompatActivity {
    ...
    private void resetTargetAnimation() {
        ...
        ObjectAnimator animator2 = ObjectAnimator.ofFloat(findViewById(R.id.target),
                "scaleX", 1, 2);
        ...
        ObjectAnimator animator3 = ObjectAnimator.ofFloat(findViewById(R.id.target),
                "scaleY", 1, 2);
        ...
        ObjectAnimator animator4 = ObjectAnimator.ofFloat(findViewById(R.id.target),
                "alpha", 1.0f, 0.5f);

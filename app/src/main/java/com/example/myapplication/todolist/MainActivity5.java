...
import com.example.myapplication.todolist.db.TodoContract.TodoNote;
import com.example.myapplication.todolist.db.TodoDbHelper;
import com.example.myapplication.todolist.debug.DebugActivity;
...
//                        .setAction("Action", null).show();
                startActivityForResult(
                        new Intent(MainActivity5.this, NoteActivity.class),
                        REQUEST_CODE_ADD);
            }
        });
        ...
        notesAdapter = new NoteListAdapter(new NoteOperator() {
            ...
            public void deleteNote(Note note) {
                MainActivity5.this.deleteNote(note);
            }

            @Override
            public void updateNote(Note note) {
                MainActivity5.this.updateNode(note);
            }
        });
